...
#========================Detail Frame =====================================       
        ...
        showallbtn=Button(Detail_Frame,text="Report Gen.",width=10,pady=5,command=self.fetch_data).grid(row=0,column=4,padx=10,pady=10)
...
#===========Table Frame==========================
    ...
    def add_students(self):
        ...
        #elif self.Roll_No_var.get() or self.email_var.get() or self.contact_var.get():
        #        messagebox.showwarning("warning","Already exist!!!")
        
        else:           
                con=mysql.connector.connect(host="localhost",user="root",password="",database="razz")
                cur=con.cursor()
